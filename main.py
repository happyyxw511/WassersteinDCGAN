...
flags.DEFINE_string('dataset', default_value='cifar10', docstring='dataset')
...
flags.DEFINE_integer('num_critic', default_value=1, docstring='number of critic training iterations')
...
flags.DEFINE_integer('img_size', default_value=32, docstring='the size of the image')
